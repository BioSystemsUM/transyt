...
public class FetchCompoundsByName2 {
	...
	private static final Logger logger = LoggerFactory.getLogger(FetchCompoundsByName2.class);
	 ...
	 * @return
	 */
	public FetchCompoundsByName2(BiodbGraphDatabaseService service, boolean useCache) {
								...
								if(!id.equals(previousID)) {
									...
									if(previousNode.hasProperty("formula")) {
										...
										if(formula2.equals(previousFormula)) {
											...
											Integer currentEntryID = FetchCompoundsByName2.getIDNumberFormat(entryID, label);

											Integer previousEntryID = FetchCompoundsByName2.getIDNumberFormat(previousNode.getProperty("entry").toString(), label);
