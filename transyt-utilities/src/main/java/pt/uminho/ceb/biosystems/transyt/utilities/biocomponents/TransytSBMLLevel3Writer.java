...
public class TransytSBMLLevel3Writer {
	...
	private static final String MERLIN_NAME = "TranSyT - www.merlin-sysbio.org";
	private static final String TRANSYT = "TranSyT";
	private static final String TRANSYT_VERSION = "1.1";
...
//	public static String CELLDESIGNER_NAMESPACE_URI = "http://www.sbml.org/2001/ns/celldesigner";
	...
	public TransytSBMLLevel3Writer(){}

	public TransytSBMLLevel3Writer(String path, Container container, Integer taxonomyID, boolean writeObjectives) {
	...
	public TransytSBMLLevel3Writer(String path,Container container, Integer taxonomyID, boolean writeObjectives, String modelID){
		this(path,container,taxonomyID,writeObjectives);
		this.modelID = modelID;
	}

	public TransytSBMLLevel3Writer(String path,Container container, Integer taxonomyID, boolean writeObjectives, String modelID, boolean palssonSpecific, boolean writeUnits){
		this(path,container,taxonomyID,writeObjectives,modelID);
		this.palssonSpecific = palssonSpecific;
		this.writeUnits = writeUnits;
	}

	public TransytSBMLLevel3Writer(String path,Container container, Integer taxonomyID, boolean writeObjectives, String modelID, boolean palssonSpecific,SBMLLevelVersion lv, boolean writeUnits){
		this(path,container,taxonomyID,writeObjectives,modelID,palssonSpecific, writeUnits);
		this.levelAndVersion = lv;
	}

	public TransytSBMLLevel3Writer(String path,Container container, Integer taxonomyID, boolean writeObjectives, String modelID, boolean palssonSpecific,boolean writeMath,SBMLLevelVersion lv, boolean writeUnits){
		this(path,container,taxonomyID,writeObjectives,modelID,palssonSpecific, writeUnits);
...
//		}
		...
		writer.setProgramName(TRANSYT);
		writer.setProgramVersion(TRANSYT_VERSION);
	...
	public void writeNotes(SBMLDocument document, Model model){
		...
		if(id==null)
			id="ID";
		if(name==null)
			name="Model exported by TranSyT software";
		model.setId(id);
		model.setName(name);
	...
	public void writeModelAnnotations(Model model) {
		...
		if(this.taxonomyID != null) {
			...
			CVTerm taxonomy = new CVTerm(Qualifier.BQB_HAS_TAXON, this.taxonomyID.toString());
...
//		 */
	...
	public void loadReactions(Model model, UnitDefinition unitDef){
		...
		for(String rId : container.getReactions().keySet()){
			...
			String reactionID = standardizerReactId(ogreaction.getName(),ogreaction.getType());
			Reaction sbmlReaction = new Reaction(levelAndVersion.getLevel(), levelAndVersion.getVersion());

			sbmlReaction.setId(rId);
			sbmlReaction.setName(rId);
...
//		 */
	...
	public String standardGeneID(String oldGeneID) {
		...
		String newGeneID = oldGeneID;
		
		if(!oldGeneID.startsWith("G_")) {

			newGeneID = "G_".concat(oldGeneID).replace(".", "__");
...
//		System.out.println(">>" + newGeneID);
	 ...
	 */
	public void setTaxonomyID(Integer taxID) {
